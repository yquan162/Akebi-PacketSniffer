...
namespace sniffer
{
	...
	std::optional<UnionPacketParseResult> PacketParser::ParseAbilityInvokeEntry(ProtoMessage& parent, ProtoNode& entry)
	{
		static std::unordered_map<std::string, std::string> ability_type_to_proto = 
		{
			...
			//{ "ABILITY_INVOKE_ARGUMENT_META_COMMAND_MODIFIER_CHANGE_REQUEST", "AbilityMetaCommandModifierChangeRequest" },
			{ "ABILITY_INVOKE_ARGUMENT_META_SPECIAL_FLOAT_ARGUMENT", "AbilityMetaSpecialFloatArgument" },
			//{ "ABILITY_INVOKE_ARGUMENT_META_OVERRIDE_PARAM", "AbilityMetaOverrideParam" },
			//{ "ABILITY_INVOKE_ARGUMENT_META_CLEAR_OVERRIDE_PARAM", "AbilityMetaClearOverrideParam" },
			{ "ABILITY_INVOKE_ARGUMENT_META_REINIT_OVERRIDEMAP", "AbilityMetaReinitOverridemap" },
			//{ "ABILITY_INVOKE_ARGUMENT_META_GLOBAL_FLOAT_VALUE", "AbilityMetaGlobalFloatValue" },
			//{ "ABILITY_INVOKE_ARGUMENT_META_CLEAR_GLOBAL_FLOAT_VALUE", "AbilityMetaClearGlobalFloatValue" },
			//{ "ABILITY_INVOKE_ARGUMENT_META_ABILITY_ELEMENT_STRENGTH", "AbilityMetaAbilityElementStrength" },
			...
			//{ "ABILITY_INVOKE_ARGUMENT_ACTION_EFFECT", "AbilityActionEffect" },
			...
			{ "ABILITY_INVOKE_ARGUMENT_ACTION_APPLY_LEVEL_MODIFIER", "AbilityActionApplyLevelModifier" },
			...
			//{ "ABILITY_INVOKE_ARGUMENT_MIXIN_MONSTER_DEFEND", "AbilityMixinMonsterDefend" },
	...
	std::optional<UnionPacketParseResult> PacketParser::ParseCombatInvokeEntry(ProtoMessage& parent, ProtoNode& entry)
	{
		static std::unordered_map<std::string, std::string> combat_type_to_proto = {
			...
			{ "COMBAT_TYPE_ARGUMENT_FORCE_SET_POSITION_INFO", "EvtCombatForceSetPosInfo" },
